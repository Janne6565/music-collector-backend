...
class PhotoMergeTest {
    ...
    private static SyncPhotoDto photo(int sortIndex, Long deletedAt, Map<String, String> clocks) {
        return new SyncPhotoDto(
                "p1", "c1", "user/p1", "image/jpeg", 2048L, sortIndex, 1000L, deletedAt, clocks);
    }
    ...
    void takesTheEarlierCreationTime() {
        SyncPhotoDto early = new SyncPhotoDto("p1", "c1", "k", "image/png", 1L, 0, 300L, null, clocks());
        SyncPhotoDto late = new SyncPhotoDto("p1", "c1", "k", "image/png", 1L, 0, 900L, null, clocks());
    ...
    void refusesToMergeTwoDifferentPhotos() {
        ...
        SyncPhotoDto other = new SyncPhotoDto("p2", "c1", "k", "image/png", 1L, 0, 1L, null, clocks());
